...
const Navbar = () => {
    return (
        <div className="ml-36 max-w-5xl">
            <ul className="flex flex-wrap gap-5 text-sm font-normal text-[#4B5665] items-center">
            ...
            <ul className="flex flex-wrap  gap-5 text-sm text-[#5C6874] font-normal items-center mt-5">
                <li>Home</li>
